...
export class ProductosService {
  ...
  public async eliminarProducto(idProducto) {
    return await this.http.delete("/api/v1/products/".concat(idProducto));
  }

  public async agregarProducto(producto: Producto) {
    return await this.http.post("/api/v1/products", producto);
  }
  ...
  public async obtenerProductos() {
    return await this.http.get("/api/v1/products");
  }
  ...
  public async obtenerProductoConFotosPorId(idProducto) {
    return await this.http.get("/api/v1/products/".concat(idProducto));
  }
}
